...
| LEGI — droit consolidé (DILA) | **Piste ouverte** — l'avant/après de chaque article de code modifié par une loi | Un incrément par jour | [`legi-droit-consolide.md`](legi-droit-consolide.md) |
